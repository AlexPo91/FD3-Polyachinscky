...
render() {
  ...
  return (
    <tr>
      ...
      <td className="tdEditBtn"><input type="button" value="Редактировать" onClick={this.editedClient} /></td>
      <td className="tdDeleteBtn"><input type="button" value="Удалить" onClick={this.deleteClient} /></td>
    </tr>
  );
}
}
